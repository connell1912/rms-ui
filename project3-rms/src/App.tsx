...
import CreateBuildingComponent from "./campus-service/components/building-components/CreateBuildingComponent";
        ...
        <Provider store={store}>
          <Router history={history}>
            ...
            <Switch>
              ...
              <Route path="/createbuilding" component={CreateBuildingComponent}/>
