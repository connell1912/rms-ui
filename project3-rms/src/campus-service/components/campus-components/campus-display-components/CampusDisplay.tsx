    ...
    return (
        <>
         ...
         <TableRow key={props.campus.campusId}>
             <TableCell key={props.campus.campusId}>{props.campus.campusId}</TableCell>
             <TableCell key={props.campus.name}>{props.campus.name}</TableCell>
             <TableCell key={props.campus.abbrName}>{props.campus.abbrName}</TableCell>
             <TableCell key={props.campus.shipAddress}>{props.campus.shipAddress}</TableCell>
             <TableCell key={props.campus.trainingManagerId}>{props.campus.trainingManagerId}</TableCell>
             <TableCell key={props.campus.stagingManagerId}>{props.campus.stagingManagerId}</TableCell>
