          ...
          <FormGroup row>
            ...
            <Col sm={10}>
              ...
              >
                ...
                <option value={amenityTypeEnum.COFFEE_FILTERS}>COFFEE_FILTERS</option>
                <option value={amenityTypeEnum.COFFEE_CREAMER}>COFFEE_CREAMER</option>
                <option value={amenityTypeEnum.PAPER_TOWELS}>PAPER_TOWELS</option>
                <option value={amenityTypeEnum.CLEANING_WIPES}>CLEANING_WIPES</option>
                <option value={amenityTypeEnum.WHITEBOARD_MARKERS}>WHITEBOARD_MARKERS</option>
                <option value={amenityTypeEnum.WHITEBOARD_ERASERS}>WHITEBOARD_ERASERS</option>
              </Input>
            </Col>
            </FormGroup>
            <FormGroup row>
